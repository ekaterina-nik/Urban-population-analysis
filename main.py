...
# в датафрейме большое количество строк с незаполненной фактической численностью по годам до 2020 года - необходимо либо заполнить их верными данными из источников, 
# либо удалить, что в данном коде не реализовано
...
# по этим графикам мы можем судить, насколько хорошо моделирование согласуется с фактическими данными и видеть рост/падение численности населения                   
...
# чтобы оценить рост/падение численности населения
